...
public class NextCurrentPage2 extends AppCompatActivity {
...
//    private ArrayList<String> mUsernames;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_current_page2);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                while (itr.hasNext()) {
                    ...
                    if (n.equals(id)) {
                        Toast.makeText(NextCurrentPage2.this, "Data Found", Toast.LENGTH_SHORT).show();
                ...
                if (flag == 0) {
                    Toast.makeText(NextCurrentPage2.this, "Data Not Found", Toast.LENGTH_SHORT).show();
                    ...
                    {
                        Toast.makeText(NextCurrentPage2.this, "Your Values Are Normal!!!Relaxxx", Toast.LENGTH_SHORT).show();
                        calling.setEnabled(false);

                    }
                    else
                    {
                        Toast.makeText(NextCurrentPage2.this, "Your Values Are Not Normal", Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(NextCurrentPage2.this, "Error:" + databaseError, Toast.LENGTH_SHORT).show();
