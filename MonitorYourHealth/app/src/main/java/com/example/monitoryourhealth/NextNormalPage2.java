...
public class NextNormalPage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_normal_page2);
        ...
        mDatabase.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                while(itr.hasNext())
                {
                    ...
                    if (n.equals(id))
                    {
                        Toast.makeText(NextNormalPage2.this, "Data Found", Toast.LENGTH_SHORT).show();
                ...
                if(flag==0)
                {
                    Toast.makeText(NextNormalPage2.this, "Data Not Found", Toast.LENGTH_SHORT).show();
            ...
            {
                Toast.makeText(NextNormalPage2.this, "Error:"+databaseError, Toast.LENGTH_SHORT).show();
